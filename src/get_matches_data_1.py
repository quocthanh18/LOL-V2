...
riot_api_key = "RGAPI-8c516502-596f-41de-9ce9-38e7824e033e"

def main():
    s = requests.Session()
    matches = open("data/batch_1.txt", "r").read().splitlines()
    matches = matches[matches.index("KR_7108823140") + 1: ]
    with open("data/batch_1_data.csv", "a") as f:
